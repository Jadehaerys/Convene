      ...
      <div className="auth__left">
        ...
        <div className="auth__left-content">
          ...
          <div className="auth__brand">
            ...
            <p className="auth__brand-tagline">AI + Blockchain Education Platform</p>
          </div>
          ...
          <div className="auth__left-pills">
            <div className="auth__pill">
              ...
              <div>
                <div className="auth__pill-title">Blockchain Verified</div>
                <div className="auth__pill-sub">All credentials on-chain</div>
              </div>
            </div>
            <div className="auth__pill">
              <span className="auth__pill-icon"></span>
            ...
            <div className="auth__form anim-ready">
              ...
              <div className="auth__roles">
                ...
                >
                  ...
                  <div className="auth__role-desc">Publish your credentials on-chain, manage your schedule, and build a tamper-proof reputation.</div>
            ...
            <div className="auth__form anim-ready">
              <div className="auth__form-header">
                ...
                <p className="auth__form-sub">
                  {role === 'tutor'
                    ? 'Set up your profile and publish your credentials on-chain.'
