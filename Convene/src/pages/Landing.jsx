...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Every certificate, degree, and teaching record is stored on an immutable ledger. Fraud is structurally impossible.',
    accent: 'teal',
  },
  {
    icon: (
  ...
  },
  {
    ...
    desc: "Decentralized reviews that can't be gamed, deleted, or manipulated. Educator reputations are permanently verifiable.",
    accent: 'teal',
  },
  {
    icon: (
...
const STEPS = [
  ...
  { num: '02', title: 'Get matched', desc: 'AI ranks tutors by semantic fit with your goals. See verified credentials and blockchain-authenticated ratings at a glance.' },
...
const TICKER_ITEMS = [
  '🔗 Blockchain Verified', '🤖 NLP Matching', '📝 AI Summaries', '⛓ Tamper-Proof Ratings',
  '🎓 Cebu Educators', '✅ Credential Ledger', '🔍 Smart Search', '📅 Live Booking',
  '🔗 Blockchain Verified', '🤖 NLP Matching', '📝 AI Summaries', '⛓ Tamper-Proof Ratings',
  '🎓 Cebu Educators', '✅ Credential Ledger', '🔍 Smart Search', '📅 Live Booking',
];
        ...
        <div className="container hero__content">
          <div className="hero__left">
            <div className="hero__badges" data-hero>
              <Badge variant="chain" dot>Blockchain Secured</Badge>
            ...
            <p className="hero__sub" data-hero>
              Convene is an AI and blockchain-enabled consultation platform for students and educators in Cebu — built to eliminate search friction, credential fraud, and learning loss.
            </p>
            ...
            <div className="hero__proof" data-hero>
              ...
              <div className="hero__proof-text">
                <strong>200+ tutors</strong> verified on-chain in Cebu
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="display-lg">
              ...
              <span className="gradient-yellow">secured on-chain.</span>
            </h2>
      ...
      <section className="tutors-section" id="for-tutors">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-sub">Every rating and credential is stored immutably on-chain. What you see is what's real.</p>
          </div>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-inner">
            ...
            <p className="cta-sub">
              Join the platform that puts AI and blockchain to work for your education.
            </p>
      ...
      <footer className="landing-footer">
        <div className="container landing-footer__inner">
          <div className="landing-footer__brand">
            ...
            <p className="landing-footer__tagline">AI + Blockchain Education Platform</p>
